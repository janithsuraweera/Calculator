          ...
          children: [
            ...
            _buildSection(context, 'Help & Support', Icons.help_outline, [
              _buildHelpItem(
                ...
                'Tap numbers and operators to perform calculations. Use = to calculate result.',
              ),
              _buildHelpItem(
                context,
                'How to use Scientific Mode',
                'Tap the science icon to switch to scientific mode. Use sin, cos, tan, log, ln, sqrt, and other functions.',
              ),
              _buildHelpItem(
                context,
                'Undo/Redo',
                'Use the undo/redo buttons in the app bar, or swipe left/right on the screen.',
              ),
              _buildHelpItem(
                context,
                'History',
                'View your calculation history in the History tab. Tap any item to reuse it.',
              ),
              _buildHelpItem(
                context,
                'Handwriting Input',
                'Tap the edit icon to draw mathematical expressions. The app will recognize and calculate them.',
              ),
              _buildHelpItem(
                context,
                'AR Mode',
                'Tap the camera icon to use AR mode. Point your camera at numbers or expressions to calculate.',
              ),
              _buildHelpItem(
                context,
                'Vault Mode',
                'Enable vault mode in settings to securely store sensitive calculations with PIN or biometric lock.',
              ),
            ]),
            const SizedBox(height: 24),
